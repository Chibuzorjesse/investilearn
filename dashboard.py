...
with st.expander("🎯 Advanced Filters (Optional)"):
    ...
    with col_filter1:
        industry = st.selectbox(
            "Industry",
            ["All Industries", "Technology", "Healthcare", "Finance", "Consumer Goods", 
             "Energy", "Industrials", "Real Estate", "Utilities"]
        )
...
if search_query:
    ...
    with col2:
        ...
        if ratio_category == "Profitability":
            st.info("💡 **Profitability ratios** measure how efficiently a company generates profit")
            metrics = ["ROE (Return on Equity)", "ROA (Return on Assets)", 
